...
\supervisor{Dr. COJOCAR Dan, Lector Universitar} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{BREBAN Sergiu} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
