...
This paper presents a different approach to the parental control problem, one that is more aware of the child behavior and does not rely only on restriction and monitoring. Parents need to have some control over the content their children seen online and the children need to be protected from all the risks online. But the majority of existing parental control solution are supported by features of control, and only few of them include self-regulation features. We designed our system to support collaborative practices between parents and children, while including the minimal control features. The children are protected from ads and other content that may negatively influence their development and the parents can see a summary of Internet activity, in order to encourage discussion. The restriction and monitoring are part of the active mediation component of parental control. The other important component is the self-regulation one, which is represented by a quiz-taking application. The children can earn extra Internet time over their daily limit by working on some quizzes the parents prepare for them. The rewards children can get for taking a quiz are limited, and the system tries to encourage learning and spending valuable time online.
\end{abstract}
